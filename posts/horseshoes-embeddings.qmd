...
Here, $s_0$ is the distance scale at which distances become "large". For $x\ll x_0$, $s(x)\approx x$, but for $x\gg x_0$, the value $s(x)$ is capped at $x_0$. We can plot this function, for a particular choice of $x_0$:
