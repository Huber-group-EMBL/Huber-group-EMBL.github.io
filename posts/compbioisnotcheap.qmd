...
A favorite fantasy of some of my experimental colleagues is the fully-trained, competent computational biology PhD student or postdoc a few months before the end of their contract, sitting there waiting to be parachuted into an existing project in the colleague's lab that has jammed up, and quickly "do the analyses".^[Of course, simple empiricism tells us that this scenario would be exceedingly unusual. But we might also savor the conceptual conditions for such a thing to be true: the researcher's other projects would have to have finished before time. The person would be competent, but have no own important ideas. They would be motivated by a middle-authorship on some paper rather than, say, money.]

Not rarely this goes along with the view that computational research is cheap, its funding can be dealt with as an afterthought, and/or can be the first to be slashed when things get tough.

It reminds me of that story of Pablo Picasso.
