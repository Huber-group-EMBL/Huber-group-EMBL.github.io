...
description: "Choosing tools for constructing bioinformatics workflows"
...
Similarly, just at a slightly higher level of abstraction, bioinformatics workflow builders should care about data structures such as dataframe, SummarizedExperiment, AnnData, etc. Whether the thing you call is written in R, Python, Rust, bash, awk, ... has some undeniable consequences -- e.g., how easy will I personally find to install, debug or extend it --, but seems quite low on the list of important criteria.
