...
**The tours below involve parts that are off-road, washed-out single trails, steep descents. Please use with caution. Even though the routes were fine for biking when I recorded them, changes are always possible, e.g., due to forest works, falling trees, erosion, etc.**

A full suspension mountain bike is recommend for these tours. The altitude measurements in the GPX files seem to be some 60m too high, possibly an artefact of my phone.
