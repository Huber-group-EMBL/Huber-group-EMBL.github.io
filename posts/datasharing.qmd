...
Of course you (as a researcher) can always cut corners. There seems to be a trade-off^[I'm not judging the two sides; e.g., there can be legitimate reasons to write many small papers, such as the need for trainees to each have "their" paper.]: more papers but each with lower quality and on average less impact, versus fewer papers but with higher quality.
