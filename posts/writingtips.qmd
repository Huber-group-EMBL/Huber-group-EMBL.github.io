...
#| output: asis 
tips = c(
"### Select content and rhetoric structure",
...
"[The difference between doing a project and presenting it](../photos/yanai-manuscript-structures.png). An observation (a dataset) can lead to many avenues of exploration before focus turns to a specific discovery. Presenting it, in a talk or paper, follows inversely, with broad perspectives coming before and after the specific discovery. [(From Itai Yanai)](https://bsky.app/profile/did:plc:hfp3die5v5ojjt3bdm2luips/post/3lwnia5ojxc2c)",
...
"Define each term. Stick with the conventions of your field. Consult textbooks, reviews, or an LLM to find out. Only if you have a very good reason, make up your own definitions. Try to keep your paper self-contained and provide all necessary definitions in your text. Also provide a reference that readers can consult to learn more.",
...
"In biomedical studies, use the word 'patient' if you mean the actual person, i.e., a human being with life history, family, feelings, undergoing medical treatment. Use another word if you are just referring to blood samples or tissue biopsies.",
...
"Use a tool that allows collaborative editing in a team and keeps version history. There are several options. I like [Quarto manuscripts](https://quarto.org/docs/manuscripts/) and a version control system like Git for quantitative work that involves data visualizations and/or maths. For short, simple documents and a WYSIWYG experience, Onlyoffice cloud seems to be an option.",
