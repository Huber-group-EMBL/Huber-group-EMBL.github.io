...
"Use a tool that allows collaborative editing in a team, and keeps version history. For quantitative work, my favorite is [Quarto manuscripts](https://quarto.org/docs/manuscripts/)^[Of course, there is also still $\\LaTeX$, but that system is essentially 25 years old, hardly interacts with the web or HTML, and functionality-wise is largely superseded by Quarto.], otherwise, Googledocs.",
