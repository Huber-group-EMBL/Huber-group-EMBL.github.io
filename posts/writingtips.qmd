...
- Present experimental observations and measurements in past tense, and interpretations and conclusions in present tense. The statements in past tense are the real, hard substance of the paper that make it worthwhile. Anyone can speculate and toss around generalities. Use active voice for things that you did--to distinguish from what others did or from what already pre-existed e.g. from prior work.
...
- In biomedical studies, use the word "patients" if you mean the actual people, i.e., persons with life histories, families, feelings. Use another word if you are just referring to blood samples or tissue biopsies. 
- Don't say "X represents Y" when you just mean "X is Y". (Doing so exposes you as pompous and careless of logical thinking.)
