...
"[The difference between doing a project and presenting it](../photos/yanai-manuscript-structures.png). An observation (a dataset) can lead to many avenues of explorations before focus turns to a specific discovery. Presenting it, in a talk or paper, follows inversely, with broad perspectives coming before and after the specific discovery. [(From Itai Yanai)](https://bsky.app/profile/did:plc:hfp3die5v5ojjt3bdm2luips/post/3lwnia5ojxc2c)",
