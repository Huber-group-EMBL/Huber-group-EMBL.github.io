...
![Cluster-free differential expression analysis of sc-RNA-seq data using LEMUR. [Paper link](https://doi.org/10.1038/s41588-024-01996-0).](photos/clusterfreeDE-2048x1649.png){width=240 fig-align="center"}

![Beautiful R.](photos/R-dh.jpg){width=240 fig-align="center"}
...
We run the annual summer school CSAMA—Biological Data Science. It usually takes place in June in Brixen/Bressanone. [Here is the webpage of the 2025 edition](https://csama2025.bioconductor.eu). See [here for some impressions](https://www.huber.embl.de/group/posts/2023-06-16-csama.html).

In July 2023, 2024 and 2025, we co-organized the [Ukrainian Biological Data Science Summer School](https://www.bds3.org) in Uzhhorod, Ukraine. See also [Wolfgang's post about it](posts/2025-07-ubds3.html).
