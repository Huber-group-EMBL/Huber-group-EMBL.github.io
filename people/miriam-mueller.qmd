...
![Miriam Müller](Miriam Mueller.jpg){width=500 fig-align="center"}

Miriam is a bioinformatician and works as a data manager and research software engineer for the INTeRCePT consortium
in collaboration with The LOOP Zürich. She holds a M.Sc. in Medical Biology from Radboud University (Netherlands) and two bachelors in Bioinformatics (B.Sc. B.S.) from the Johannes Kepler University in Linz (Austria) and the University of South Bohemia (Czech Republic).
